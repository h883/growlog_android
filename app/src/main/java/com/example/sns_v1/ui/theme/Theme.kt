...
private val LightColorScheme = lightColorScheme(
    ...
    outline = BorderColor,
    secondary = androidx.compose.ui.graphics.Color(0xFF00629D),
    onSecondary = CardBackground,
    error = ErrorRed,
    // 未指定だとダイアログやチップに M3 既定の紫が出るので、全段階を明示する
    surfaceContainerLowest = CardBackground,
    surfaceContainerLow = SubBackground,
    surfaceContainer = SubBackground,
    surfaceContainerHigh = SubBackground,
